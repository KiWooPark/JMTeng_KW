...
class DefaultRestaurantDetailCoordinator: RestaurantDetailCoordinator {
    ...
    func start() {}
    func start(id: Int) {
        guard let restaurantDetailViewController = RestaurantDetailViewController.instantiateFromStoryboard(storyboardName: "RestaurantDetail") as? RestaurantDetailViewController else { return }
    ...
    func handleImagePickerResult(_ images: [UIImage], isDefault: Bool) {
        if let restaurantDetailViewController = navigationController?.topViewController as? RestaurantDetailViewController {
