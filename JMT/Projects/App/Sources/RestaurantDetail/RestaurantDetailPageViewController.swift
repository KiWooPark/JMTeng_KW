...
class RestaurantDetailPageViewController: UIPageViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        guard let infoViewController = vcArray[0] as? RestaurantDetailInfoViewController else { return }
        guard let photoViewController = vcArray[1] as? RestaurantDetailPhotoViewController else { return }
        guard let reviewViewController = vcArray[2] as? RestaurantDetailReviewViewController else { return }
