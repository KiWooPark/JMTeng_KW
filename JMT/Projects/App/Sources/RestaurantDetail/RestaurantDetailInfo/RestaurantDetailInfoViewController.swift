...
extension RestaurantDetailInfoViewController: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        case UICollectionView.elementKindSectionHeader:
            ...
            case 0:
                guard let header = collectionView.dequeueReusableSupplementaryView(ofKind: kind,
                                                                                   withReuseIdentifier: "RestaurantDetailTitleHeaderView",
                                                                                   for: indexPath) as? RestaurantDetailTitleHeaderView else { return UICollectionReusableView() }
        ...
        case UICollectionView.elementKindSectionFooter:
            ...
            case 2:
                guard let header = collectionView.dequeueReusableSupplementaryView(ofKind: kind,
                                                                                   withReuseIdentifier: "RestaurantDetailFooterView",
                                                                                   for: indexPath) as? RestaurantDetailFooterView else { return UICollectionReusableView() }
